...
class Civilian_data(models.Model):
	...
	dob = models.DateField(validators=[validate_date],null=True,blank=True)
	...
	state = models.CharField(max_length=40,choices=state_choices,default="Delhi",null=True,blank=True)
	country = models.CharField(max_length=5,choices=country_choice,default="India",null=True,blank=True)
