...
def data_entry(request):
	...
	if 'data_entry_form' in request.POST:
	    ...
	    message_to_broadcast = ("Hello \n Data entered is \n Name = %s %s , \n aadhar num = %d, DOB = %s, Sex = %s, Email = %s, Address = %s  %s %s , Occupation = %s, FamilyMem NO = %s" %(fnameobj1, lnameobj1, aadhaar_noobj1, DOBobj1, sexobj1, emailobj1, addressobj1, cityobj1, stateobj1, occuobj1, fam_memobj1))
